...
public class Main {
	...
	// write your code here
        System.out.println("====Switch Keyword====");
        ...
        switch (customerStatus) {
            ...
            case "regular_customer":
                System.out.println("Thank you for your purchase! Take discount 10% for your order "+"as a gratitude for staying with us.");
                break;
        ...
        System.out.println("====Default block view====");
        int j = 10;
        switch (j){
            case 1:
                System.out.println("one");
